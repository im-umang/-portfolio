    ...
    <AnimatePresence>
      {visible && (
        <motion.div
          ...
          className="fixed bottom-6 right-6 z-[9999] flex items-center gap-2 p-1.5 rounded-full bg-[#090f1d]/85 backdrop-blur-xl border border-white/15 shadow-[0_8px_32px_rgba(0,0,0,0.5)]"
        >
