  ...
  return (
    <div className="relative min-h-screen bg-background text-foreground overflow-x-hidden flex flex-col justify-between">
      <SEO
        ...
        description="Endorsements, client reviews, peer feedback, and project testimonials for Umang Trivedi's full-stack web engineering and digital architecture."
        canonical="/reviews"
      />
